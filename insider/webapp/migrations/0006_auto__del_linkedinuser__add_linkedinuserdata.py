...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LinkedInUserData'
        db.create_table(u'webapp_linkedinuserdata', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('access_token', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True)),
            ('expires_in', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ...
        db.send_create_signal(u'webapp', ['LinkedInUserData'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'LinkedInUserData'
        db.delete_table(u'webapp_linkedinuserdata')
